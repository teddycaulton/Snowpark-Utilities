...
setup(
  ...
  description = 'A helpful package for making snowpark code easier to write and more read',   # Give a short description about your library
  ...
  download_url = 'https://github.com/teddycaulton/Snowpark-Utilities/archive/refs/tags/v_013.tar.gz',    # I explain this later on
